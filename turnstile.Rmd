...
Now we're going to combine the the income-geolocated data from Sam. Also going to read in the full cleaned up data, mta_cleanr. (I just did this to save time compiling on my computer)
...
Let's look at stations that include "42" for 42nd street and we can see the discrepincies. 
